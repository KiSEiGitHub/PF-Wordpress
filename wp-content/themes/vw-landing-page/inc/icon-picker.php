        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-landing-page' ); ?>">
                </div>
...
function vw_landing_page_customizer_script() {
    ...
    wp_enqueue_script( 'vw-landing-page-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
