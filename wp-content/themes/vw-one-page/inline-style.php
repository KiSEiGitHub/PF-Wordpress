<?php
	...
	$vw_one_page_slider = get_theme_mod('vw_one_page_slider_hide_show');
	if($vw_one_page_slider == false){
		$vw_one_page_custom_css .='#services-one{';
			$vw_one_page_custom_css .='margin-top: 5em;';
		$vw_one_page_custom_css .='}';
		$vw_one_page_custom_css .='@media screen and (max-width:992px) {';
		$vw_one_page_custom_css .='#services-one{';
			$vw_one_page_custom_css .='margin-top: 0em;';
		$vw_one_page_custom_css .='} }';
	}
	...
	$vw_one_page_resp_topbar = get_theme_mod( 'vw_one_page_resp_topbar_hide_show',false);
	if($vw_one_page_resp_topbar == true && get_theme_mod( 'vw_one_page_topbar_hide_show', false) == false){
    	$vw_one_page_custom_css .='#topbar{';
	...
	$vw_one_page_resp_slider = get_theme_mod( 'vw_one_page_resp_slider_hide_show',false);
	if($vw_one_page_resp_slider == true && get_theme_mod( 'vw_one_page_slider_hide_show', false) == false){
