...
?>
<div id="top-header">
  <div class="header-menu <?php if( get_theme_mod( 'vw_one_page_sticky_header', false) != '' || get_theme_mod( 'vw_one_page_stickyheader_hide_show', false) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
    <div class="container">
      <div class="row">
